...
var seconds = 70; //número de segundos a contar
...
?>
	...
	<div class="panel-heading">
		<h3>
			Ingresa tu clave Dinámica, la puedes encontrar ingresando en tu App Personas.
		</h3>
	</div>
</div>
  ...
  <br> <br>
  <font size="4px;" color="">Ingresa tu clave Dinamica proporcionada desde la App Personas. Nota: Valida por un (1) minutos.<br><span>
